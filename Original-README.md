...
🕵🏻‍♂️ Inspect the `Debug Contracts` tab to figure out what address is the `owner` of `StrangerCats`?

🔏 You can also check out your smart contract `StrangerCats.sol` in `packages/hardhat/contracts`.
